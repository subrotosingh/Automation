...
test.describe(
  ...
  () => {
    ...
    test("verify user navigates to shop page", async ({ page }) => {
    ...
    test("verify presence of tiles on the shop page", async ({ page }) => {
    ...
    test("verify list of deals on the deals page", async ({ page }) => {
      await page
        .locator('[data-test-id="primary-nav-list"] >> text=Deals')
        .click();
      await expect(page).toHaveURL("https://www.sky.com/deals");
